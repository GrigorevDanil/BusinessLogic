...
{
    public partial class TransportMethodDialog : Form
    {
        public TransportMethodDialog()
        {
            InitializeComponent();
        }
        ...
        public void Calculate(double[,] A, double[] suppliers, double[] demands)
        {
            ...
            */
            ...
            {
                Console.Write($"{demand,4}\t");
            }
            Console.WriteLine();
            Console.WriteLine();
            Console.WriteLine($"Минимальные затраты на транспортировку: {Fmin}");
        }
