...
namespace BusinessLogic.Presentation
{
	public partial class MainForm : Form {
		...
		private async void g_product_SelectionChanged(object sender, EventArgs e) {
			if (g_product.SelectedRows.Count == 0)
				return;
		...
		public async void AddProductResource(object sender, EventArgs e) {
			...
			if (dialog.ShowDialog() == DialogResult.OK) {
				...
				if (productResource.IsFailure)
					throw new Exception(productResource.Error);
		...
		public async void UpdateProductResource(object sender, EventArgs e) {
			...
			if (productResource.Value is null)
				throw new Exception("productResource не найден");
		...
		public async void AddWarehouse() {
			...
			if (dialog.ShowDialog() == DialogResult.OK) {
				...
				if (warehouse.IsFailure)
					throw new Exception(warehouse.Error);
		...
		public async void UpdateWarehouse() {
			...
			if (warehouse.Value is null)
				throw new Exception("warehouse не найден");
		...
		private async void g_warehouse_SelectionChanged(object sender, EventArgs e) {
			if (g_warehouse.SelectedRows.Count == 0)
				return;
		...
		public async void AddProductWarehouse(object sender, EventArgs e) {
			...
			if (dialog.ShowDialog() == DialogResult.OK) {
				...
				if (productWarehouse.IsFailure)
					throw new Exception(productWarehouse.Error);
		...
		public async void UpdateProductWarehouse(object sender, EventArgs e) {
			...
			if (productWarehouse.Value is null)
				throw new Exception("productWarehouse не найден");
		...
		private async void g_shop_SelectionChanged(object sender, EventArgs e) {
			if (g_shop.SelectedRows.Count == 0)
				return;
		...
		public async void UpdateDistance(object sender, EventArgs e) {
			...
			if (distance.Value is null)
				throw new Exception("distance не найден");
		...
		public async void UpdateResource() {
			...
			if (resource.Value is null)
				throw new Exception("resource не найден");
		...
		public async void AddInvestment() {
			...
			if (dialog.ShowDialog() == DialogResult.OK) {
				...
				if (investment.IsFailure)
					throw new Exception(investment.Error);
		...
		public async void UpdateInvestment() {
			...
			if (investment.Value is null)
				throw new Exception("investment не найден");
